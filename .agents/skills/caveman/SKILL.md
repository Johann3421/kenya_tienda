...
- `caveman full` (default): Full token compression. Short, high-density caveman fragments.
- `caveman ultra`: Extreme token savings. Direct code / command output only + essential keywords.

## Examples:
- **Verbose:** *"I have updated `config.php` on line 45 to change the database port to 5432 as you requested."*
- **Caveman (Full):** *"`config.php` line 45: DB port -> 5432."*
