            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <div class="page-header-title">
                        <h5 class="m-b-10" style="color: #6b6b6b;"><i class="fas fa-truck-loading"></i>Categorias</h5>
                            ...
                            <div class="modal-content" v-if="methods == 'create'">
                                <div class="modal-header" style="padding: 10px 15px">
                                    <h5 class="mb-0">NUEVO <span
                                            style="color: #929292; font-size: 17px; font-weight: 400;">(CATEGORIA)</span>
                                    </h5>
                                ...
                                <div class="modal-body" style="padding: 15px 15px;">
                                    <div class="contenedor">
                                        {{-- <div class="form-group col-md-12 form_producto">
                                            ...
                                            <input type="text" id="search_producto" v-model="search_producto" class="form-control" :class="[errors.search_producto ? 'is-invalid' : '']" :readonly="loading" v-on:keyup="AutoBuscar">

                                            <small class="form-text error-color" v-if="errors.search_producto">@{{ errors.search_producto[0] }}</small>
                                            <ul v-if="productos.length !== 0 && search_producto.length !== 0" v-show="mostrar" class="listProductos">
                                                <li v-for="producto in productos" :value="producto.id" class="item_producto" v-on:click="Fila_producto(producto.id, producto, 'save')">@{{ producto.nombre }}</li>
                                            </ul>
                                        </div> --}}
                                        <div class="contenedor1">
                                            <div class="contenedor1_categoria">
                                                <label for="categoria" class="label-sm">CATEGORÍA</label>
                                                <input type="text" id="categoria" v-model="categoria"
                                                    class="form-control" :class="[errors.categoria ? 'is-invalid' : '']"
                                                    :readonly="loading">
                                                <small class="form-text error-color"
                                                    v-if="errors.garantia">@{{ errors.categoria[0] }}</small>
                                            </div>
                            ...
                            <div class="modal-content" v-if="methods == 'delete'">
                                <div class="modal-header" style="padding: 10px 15px">
                                    <h5 class="mb-0">ELIMINAR <span
                                            style="color: #929292; font-size: 17px; font-weight: 400;">(CATEGORIA)</span></h5>
                                    <button type="button" title="Cerrar" data-dismiss="modal" aria-label="Close"
                                        v-on:click="closeModal(methods)" class="btn btn-danger btn-xs float-right"
                                        style="padding: 0px 7px;">X</button>
                                </div>
                                <div class="modal-body" style="padding: 15px 15px;">
                                    <p class="text-center">
                                        Realmente desea eliminar el Driver <strong>"@{{ categoria }}"</strong>
                                    </p>
                                </div>
                                <div class="modal-footer" style="padding: 10px 15px;">
                        ...
                        <div class="mb-3 mt-3 col-md-3">
                            <div class="p-b-10">
                                <input type="text" class="form-control" id="seacrh" v-model="search"
                                    placeholder="Descripcion de la categoria" v-on:keyup.enter="Buscar">
                            </div>
                            ...
                            <tbody>
                                ...
                                <template v-if="listTable">
                                    <template v-if="listaRequest.length != 0">
                                        <tr v-for="(categoria, index) in listaRequest"
                                            :class="{ activado: active == categoria.id }"
                                            v-on:click="Fila_categoria(categoria.id, categoria)" style="cursor: pointer;">
