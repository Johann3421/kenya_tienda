            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    ...
                    <ul class="breadcrumb" style="font-size: 15px;">
                        ...
                        <li class="breadcrumb-item"><a href="#!">Web Ofertas</a></li>
                    </ul>
                </div>
            </div>
        </div>
    </div>
    <div class="row" style="top: 40px; position: inherit;" id="form-ofertas">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5>LISTA DE OFERTAS DE LA PÁGINA WEB</h5>
                ...
                <div class="card-body">
                        ...
                        <div class="modal-dialog" :class="modal_size" role="document">
                            ...
                            <div class="modal-content" v-if="methods == 'create'">
                                <div class="modal-header" style="padding: 10px 15px">
                                    <h5 class="mb-0">NUEVA <span style="color: #929292; font-size: 17px; font-weight: 400;">(OFERTA)</span></h5>
                                ...
                                <div class="modal-body" style="padding: 15px 15px;">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-sm-6">
                                            <label for="color_fondo">Color de Fondo (clase CSS)</label>
                                            <input type="text" id="color_fondo" v-model="color_fondo" class="form-control" :class="[errors.color_fondo ? 'is-invalid' : '']" :readonly="loading" placeholder="bg-purple">
                                            <small class="form-text error-color" v-if="errors.color_fondo">@{{ errors.color_fondo[0] }} </small>
                                        </div>
                                        <div class="form-group col-sm-6">
                            ...
                            <div class="modal-content" v-if="methods == 'edit'">
                                <div class="modal-header" style="padding: 10px 15px">
                                    <h5 class="mb-0">EDITAR <span style="color: #929292; font-size: 17px; font-weight: 400;">(OFERTA)</span></h5>
                                    <button type="button" title="Cerrar" data-dismiss="modal" aria-label="Close" v-on:click="closeModal(methods)" class="btn btn-danger btn-xs float-right" style="padding: 0px 7px;">X</button>
                                </div>
                                <div class="modal-body" style="padding: 15px 15px;">
                                    <div class="form-row">
                            ...
                            <div class="modal-content" v-if="methods == 'delete'">
                                <div class="modal-header" style="padding: 10px 15px">
                                    <h5 class="mb-0">ELIMINAR <span style="color: #929292; font-size: 17px; font-weight: 400;">(OFERTA)</span></h5>
                                    <button type="button" title="Cerrar" data-dismiss="modal" aria-label="Close" v-on:click="closeModal(methods)" class="btn btn-danger btn-xs float-right" style="padding: 0px 7px;">X</button>
                                </div>
                                <div class="modal-body" style="padding: 15px 15px;">
                                    <p class="text-center">
                                        Realmente desea eliminar la Oferta Seleccionada.
                                    </p>
                                </div>
                                <div class="modal-footer" style="padding: 10px 15px;">
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 mt-3 col-md-3">
                            <div class="p-b-10">
                                <input type="text" class="form-control" id="seacrh" v-model="search" placeholder="Buscar oferta..." v-on:keyup.enter="Buscar">
                            </div>
                        ...
                        <table class="table table-sm">
                            <thead>
                                <tr>
                                    ...
                                    <th class="cell-4">Color Fondo</th>
                                    <th class="cell-5">Imagen</th>
                            ...
                            <tbody>
                                ...
                                <template v-if="listTable">
                                    <template v-if="listaRequest.length != 0">
                                        <tr v-for="(oferta, index) in listaRequest" :class="{ activado : active == oferta.id }" v-on:click="Fila(oferta.id, oferta)" style="cursor: pointer;">
                                            <td class="text-center">@{{(index + pagination.index + 1)}}</td>
                                            <td>@{{oferta.titulo}}</td>
                                            <td>@{{oferta.descripcion}}</td>
                                            <td>@{{oferta.color_fondo}}</td>
                                            <td>@{{oferta.imagen}}</td>
                                            <td class="text-center">
                                                <i class="fas fa-check-circle font-green" style="font-size: 15px;" v-if="oferta.activo == 'SI'"></i>
...
@section('js')
    <script src="{{asset('js/views/web/ofertas.js')}}?v={{ time() }}"></script>
@endsection
