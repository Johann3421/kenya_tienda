...
@section('content')
            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <div class="page-header-title">
                        <h5 class="m-b-10" style="color: #6b6b6b;"><i class="fas fa-truck-loading"></i> Proveedores</h5>
                    </div>
    ...
    <div class="row" style="top: 40px; position: inherit;" id="form-proveedor">
                            ...
                            <tbody>
                                ...
                                <template v-if="listTable">
                                    <template v-if="listaRequest.length != 0">
                                        <tr v-for="(proveedor, index) in listaRequest" :class="{ activado : active == proveedor.id }" v-on:click="Fila(proveedor.id, proveedor)" style="cursor: pointer;">
                                            <td class="text-center">@{{(index + pagination.index + 1)}}</td>
                                            <td class="text-center">@{{proveedor.numero_documento}}</td>
                                            <td>
                                                <div><i class="fas fa-proveedor"></i> @{{proveedor.nombres}}</div>
                                                <div>
                                                    <i class="fas fa-id-card"></i> @{{proveedor.direccion}} &nbsp;| &nbsp;
                                                    <i class="fas fa-phone-square"></i> @{{proveedor.telefono}}
                                                </div>

                                            </td>
                                            <td class="text-center">@{{proveedor.servicio}}</td>
                                            <td class="text-center">@{{Fecha(proveedor.updated_at)}}</td>
...
@section('js')
    <script src="{{asset('js/views/proveedor/proveedor.js')}}"></script>
@endsection
