            ...
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <div class="modal-dialog" :class="modal_size" role="document">
                            ...
                            <div class="modal-content" v-if="methods == 'create'">
                                <div class="modal-header" style="padding: 10px 15px">
                                    <h5 class="mb-0">NUEVO <span style="color: #929292; font-size: 17px; font-weight: 400;">(SOPORTE TÉCNICO)</span></h5>
                                ...
                                <div class="modal-body" style="padding: 15px 15px;">
                                    <template v-if="state != 'success'">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group row m-b-0">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input type="datetime-local" id="fecha_entrega" v-model="fecha_entrega" min="{{date('Y-m-d').'T00:00'}}"
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group row m-b-0">
                                                                <span style="font-size: 11px; padding-right: 0;padding-top: 3px;" class="col-sm-3">TÉCNICO :</span>
                                                                <div class="col-sm-9">
                                            ...
                                            <div class="col-md-3">
                                                <div class="contorno-check" style="padding: 5px 0px 3px 8px;">
                                                    ...
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input class="form-check-input check-xl" type="radio" v-model="tipo_servicio" id="soporte" value="SOPORTE">
                                                        <label class="form-check-label" style="font-size: 11px; margin: 4px;" for="soporte">SOPORTE</label>
                                                    </div>
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input class="form-check-input check-xl" type="radio" v-model="tipo_servicio" id="garantia" value="GARANTIA">
                                                        <label class="form-check-label" style="font-size: 11px; margin: 4px;" for="garantia">GARANTIA</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-9">
                                                <div class="contorno-check" style="padding: 5px 0px 3px 8px;">
                                                    ...
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input class="form-check-input check-xl" type="radio" v-model="estado_servicio" id="pendiente" value="E1">
                                                        <label class="form-check-label" style="font-size: 11px; margin: 4px;" for="pendiente">PENDIENTE</label>
                                                    </div>
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input class="form-check-input check-xl" type="radio" v-model="estado_servicio" id="diagnostico" value="E2">
                                                        <label class="form-check-label" style="font-size: 11px; margin: 4px;" for="diagnostico">DIAGNOSTICO</label>
                                                    </div>
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input class="form-check-input check-xl" type="radio" v-model="estado_servicio" id="devolver" value="E3">
                                                        <label class="form-check-label" style="font-size: 11px; margin: 4px;" for="devolver">SIN SOLUCIÓN - DEVOLVER</label>
                                                    </div>
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input class="form-check-input check-xl" type="radio" v-model="estado_servicio" id="reparando" value="E4">
                                                        <label class="form-check-label" style="font-size: 11px; margin: 4px;" for="reparando">REPARANDO</label>
                                                    </div>
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input class="form-check-input check-xl" type="radio" v-model="estado_servicio" id="listo" value="E5">
                                                        <label class="form-check-label" style="font-size: 11px; margin: 4px;" for="listo">LISTO</label>
                                                    </div>
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input class="form-check-input check-xl" type="radio" v-model="estado_servicio" id="entregado" value="E6">
                                                        <label class="form-check-label" style="font-size: 11px; margin: 4px;" for="entregado">ENTREGADO</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <div class="form-group row m-b-0">
                                                                ...
                                                                <div class="col-sm-8 m-b-5">
                                                                    <input type="text" id="numero_documento" v-model="numero_documento" :readonly="loading" maxlength="11"
                                                        ...
                                                        <div class="col-md-5">
                                                            <div class="form-group row m-b-5">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <input type="text" id="nombres" v-model="nombres" :readonly="loading"
                                                            ...
                                                            <div class="form-group row m-b-0">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <input type="text" id="direccion" v-model="direccion" :readonly="loading"
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group row m-b-5">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <input type="email" id="email" v-model="email" :readonly="loading"
                                                            ...
                                                            <div class="form-group row m-b-0">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <input type="text" id="celular" v-model="celular" :readonly="loading" maxlength="9"
                                                                    onkeypress="if (event.keyCode < 48 || event.keyCode > 57) { event.returnValue = false}"
                                            ...
                                            <div class="col-md-12">
                                                <div class="contorno-check">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <div class="form-group row m-b-0">
                                                                <span style="font-size: 11px; padding-right: 0;padding-top: 3px;" class="col-sm-4">EQUIPO :</span>
                                                                <div class="col-sm-8 m-b-5">
                                                                    <input type="text" id="equipo" v-model="equipo" :readonly="loading" autocomplete="on"
                                                                    class="form-control form-control-sm" :class="[errors.equipo ? 'is-invalid' : '']">
                                                                    <small class="form-text error-color" v-if="errors.equipo">@{{ errors.equipo[0] }} </small>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <div class="form-group row m-b-0">
                                                                <span style="font-size: 11px; padding-right: 0;padding-top: 3px;" class="col-sm-4">MARCA :</span>
                                                                <div class="col-sm-8 m-b-5">
                                                                    <input type="text" id="marca" v-model="marca" :readonly="loading" autocomplete="on"
                                                                    class="form-control form-control-sm" :class="[errors.marca ? 'is-invalid' : '']">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group row m-b-0">
                                                                <span style="font-size: 11px; padding-right: 0;padding-top: 3px;" class="col-sm-4">MODELO :</span>
                                                                <div class="col-sm-8 m-b-5">
                                                                    <input type="text" id="modelo" v-model="modelo" :readonly="loading"
                                                                    class="form-control form-control-sm" :class="[errors.modelo ? 'is-invalid' : '']">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group row m-b-0">
                                                                <span style="font-size: 11px; padding-right: 0;padding-top: 3px;" class="col-sm-4">SERIE :</span>
                                                                <div class="col-sm-8 m-b-5">
                                                                    <input type="text" id="serie" v-model="serie" :readonly="loading"
                                                                    class="form-control form-control-sm" :class="[errors.serie ? 'is-invalid' : '']">
                                                                    <small class="form-text error-color" v-if="errors.serie">@{{ errors.serie[0] }} </small>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12">
                                                            <div class="form-group row m-b-0">
                                                                <span style="font-size: 11px; padding-right: 0;padding-top: 3px;" class="col-sm-2">DESCRIPCIÓN DE LA FALLA :</span>
                                                                <div class="col-sm-10 m-b-5">
                                                                    <textarea id="descripcion" v-model="descripcion" :readonly="loading" style="max-width: 100%; padding: 0px 6px !important; font-size: 11px !important;"
                                                                    class="form-control" :class="[errors.descripcion ? 'is-invalid' : '']"></textarea>
                                        ...
                                        <div class="row m-b-10">
                                            <div class="col-md-12">
                                                <div class="contorno-check" style="padding: 5px 0px 3px 8px;">
                                                    <div class="row">
                                                        <div class="col-md-2">
                                                            <span style="font-size: 11px; padding-right: 0;padding-top: 3px;">ACCESORIOS :</span>
                                                        </div>
                                                        <div class="col-md-10">
                                                            <div class="custom-control custom-radio custom-control-inline">
                                                                <input class="form-check-input check-xl" type="checkbox" id="sin_accesorios" v-model="sin_accesorios" true-value="SI" false-value="NO" :readonly="loading">
                                                                <label class="form-check-label" for="sin_accesorios" style="font-size: 11px; margin: 5px;">SIN ACCESORIOS</label>
                                                            </div>
                                                            <div class="custom-control custom-radio custom-control-inline">
                                                                <input class="form-check-input check-xl" type="checkbox" id="cargador" v-model="cargador" true-value="SI" false-value="NO" :readonly="loading">
                                                                <label class="form-check-label" for="cargador" style="font-size: 11px; margin: 5px;">CARGADOR</label>
                                                            </div>
                                                            <div class="custom-control custom-radio custom-control-inline">
                                                                <input class="form-check-input check-xl" type="checkbox" id="cable_usb" v-model="cable_usb" true-value="SI" false-value="NO" :readonly="loading">
                                                                <label class="form-check-label" for="cable_usb" style="font-size: 11px; margin: 5px;">CABLE USB</label>
                                                            </div>
                                                            <div class="custom-control custom-radio custom-control-inline">
                                                                <input class="form-check-input check-xl" type="checkbox" id="cable_poder" v-model="cable_poder" true-value="SI" false-value="NO" :readonly="loading">
                                                                <label class="form-check-label" for="cable_poder" style="font-size: 11px; margin: 5px;">CABLE PODER</label>
                                                            </div>
                                                            <div class="custom-control custom-radio custom-control-inline" style="margin-right: 0;">
                                                                <input type="text" id="otros" v-model="otros" class="form-control form-control-sm" autocomplete="on" placeholder="Otros" style="min-width: 280px;">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row m-b-10">
                                            <div class="col-md-10"><h5>PROFORMA DE REPARACIÓN</h5></div>
                                            <div class="col-md-10">
                                                <div class="contorno-check">
                                                    <div class="row">
                                                        <div class="col-md-5">
                                                        ...
                                                        <div class="col-md-2">
                                                            <div class="form-group m-b-0">
                                                                ...
                                                                :readonly="loading" v-on:keyup.enter="Next('detalle_descuento')">
                                                                <small class="form-text error-color" v-if="errors.detalle_precio">@{{ errors.detalle_precio[0] }} </small>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2">
                                                            <div class="form-group m-b-0">
                                                                <label class="m-b-0" for="detalle_descuento">Descuento</label>
                                                                <input type="number" id="detalle_descuento" v-model="detalle_descuento" class="form-control form-control-sm" :class="[errors.detalle_descuento ? 'is-invalid' : '']"
                                                                :readonly="loading" v-on:keyup.enter="Next('detalle_cantidad')">
                                                                <small class="form-text error-color" v-if="errors.detalle_descuento">@{{ errors.detalle_descuento[0] }} </small>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2">
                                                            <div class="form-group m-b-0">
                                                        ...
                                                        <div class="col-md-1">
                                                            <button class="btn btn-success btn-block" style="padding: 8px 0; margin: 1px 0 4px 0;" v-on:click="addDetalles" title="Agregar">
                                                            ...
                                                            <table class="table table-bordered table-sm" style="width: 100%; margin-bottom: 7px;">
                                                                ...
                                                                <tbody>
                                                                    <tr v-for="(detalle, index) in listDetalles">
                                                                        ...
                                                                        <td class="text-center" style="padding: 0px 6px !important;">@{{detalle.descuento}}</td>
                                                    ...
                                                    <div class="row m-t-10">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group m-b-0">
                                                                <label class="m-b-0" for="reporte_tecnico"><i class="fas fa-chalkboard-teacher"></i> Reporte Técnico</label>
                                                    ...
                                                    <div class="row m-t-10">
                                                        ...
                                                        <div class="col-md-2">
                                                            <div class="form-group m-b-0">
                                                                ...
                                                                <input type="number" id="acuenta" v-model="acuenta" class="form-control form-control-sm" style="background-color: #fdff83; font-size: 17px !important; text-align: right;" :class="[errors.acuenta ? 'is-invalid' : '']" :readonly="loading">
                                                        ...
                                                        <div class="col-md-2">
                                                            <div class="form-group m-b-0">
                                                                ...
                                                                <input type="number" id="costo_servicio" v-model="costo_servicio" class="form-control form-control-sm" style="background-color: #ffc883; font-size: 17px !important; text-align: right;" :class="[errors.costo_servicio ? 'is-invalid' : '']" :readonly="loading">
                                                                <small class="form-text error-color" v-if="errors.costo_servicio">@{{ errors.costo_servicio[0] }} </small>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2">
                                                            <div class="form-group m-b-0">
                                                                <label class="m-b-0" for="saldo_total">Resta</label>
                                                                <input type="number" id="saldo_total" v-model="saldo_total" class="form-control form-control-sm" style="background-color: #cccccc; font-size: 17px !important; text-align: right;" :class="[errors.saldo_total ? 'is-invalid' : '']" :readonly="loading" readonly="true">
                                            ...
                                            <div class="col-md-2" style="padding-left: 0;">
                                                <div class="mb-2">
                                                    <div class="contorno-check" style="padding: 5px 0px 3px 8px;">
                                                        ...
                                                        <div class="custom-control custom-radio custom-control-inline">
                                                            <input class="form-check-input check-xl" type="radio" v-model="confirmar_reparacion" id="si_confirmar" value="SI">
                                                            <label class="form-check-label" style="font-size: 11px; margin: 4px;" for="si_confirmar">SI</label>
                                                        </div>
                                                        <div class="custom-control custom-radio custom-control-inline">
                                                            <input class="form-check-input check-xl" type="radio" v-model="confirmar_reparacion" id="no_confirmar" value="NO">
                                                            <label class="form-check-label" style="font-size: 11px; margin: 4px;" for="no_confirmar">NO</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-2">
                                                    <div class="contorno-check" style="padding: 5px 0px 3px 8px;">
                                                        <span style="color: #0075ff;">Equipo no se reparo solo se diagnostico</span>
                                                        <div class="custom-control custom-radio custom-control-inline">
                                                            <input class="form-check-input check-xl" type="checkbox" v-model="solo_diagnostico" id="si_confirmar" true-value="SI" false-value="NO">
                                                            <label class="form-check-label" style="font-size: 11px; margin: 4px;" for="si_confirmar">SI</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="mb-2">
                                                    <div :class="estado_servicio" style="border-radius: 20px;">@{{Estado(estado_servicio)}}</div>
                                                </div>
                                            </div>
                            ...
                            <div class="modal-content" v-if="methods == 'edit'">
                                <div class="modal-header" style="padding: 10px 15px">
                                    <h5 class="mb-0">
                                        EDITAR <span style="color: #929292; font-size: 17px; font-weight: 400;">(SOPORTE TÉCNICO) </span> : @{{zeroFill(id, 4)}}
                                        <button class="btn btn-warning" style="margin-left: 50px;" v-on:click="Recibo(result_id)"><i class="fas fa-print"></i> Imprimir Recibo</button>
                                                            ...
                                                            <div class="col-sm-9">
                                                                <div class="input-group input-group-sm">
                                                                    ...
                                                                    <div class="input-group-append">
                                                                        <a :href="'https://wa.me/'+celular+'?text=Hola%20'+Espacios(nombres)+',%20'+whatsapp_soporte" target="_blank" class="btn btn-whatsapp" style="padding: 0px 5px;" title="Enviar Whatsapp al Cliente"><i class="fab fa-whatsapp"></i> </a>
                                                                    </div>
                                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-5">
                                                        <div class="form-group m-b-0">
                                                            <label class="m-b-0" for="detalle_descripcion">Descripción</label>
                                                            <input type="text" id="detalle_descripcion" v-model="detalle_descripcion" class="form-control form-control-sm" :class="[errors.detalle_descripcion ? 'is-invalid' : '']"
                                                            :readonly="loading" v-on:keyup.enter="Next('detalle_precio')">
                                                            <small class="form-text error-color" v-if="errors.detalle_descripcion">@{{ errors.detalle_descripcion[0] }} </small>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2">
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="form-group m-b-0">
                                                            <label class="m-b-0" for="detalle_cantidad">Cantidad</label>
                                                            <input type="number" id="detalle_cantidad" v-model="detalle_cantidad" class="form-control form-control-sm" :class="[errors.detalle_cantidad ? 'is-invalid' : '']"
                                                            :readonly="loading" v-on:keyup.enter="addDetallesEdit">
                                                            <small class="form-text error-color" v-if="errors.detalle_cantidad">@{{ errors.detalle_cantidad[0] }} </small>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-1">
                                                        <button class="btn btn-outline-dark btn-block" style="padding: 8px 0; margin: 1px 0 4px 0;" v-on:click="addDetallesEdit" title="Agregar">
                                                            <i class="fas fa-plus" style="font-size: 20px;"></i>
                                                        </button>
                                                        ...
                                                        <table class="table table-bordered table-sm" style="width: 100%; margin-bottom: 7px;">
                                                            ...
                                                            <tbody>
                                                                <tr v-for="(detalle, index) in listDetalles">
                                                                    ...
                                                                    <td class="text-center" style="padding: 0px 6px !important;">@{{detalle.importe}}</td>
                                                                    <td class="text-center" style="padding: 0px 6px !important;">
                                                                        <a href="#" title="Eliminar Detalle" style="color: red; padding: 0 !important; font-size: 13px;" v-on:click="deleteDetallesEdit(detalle.id, index)">
                                                                            <i class="fas fa-trash"></i>
                                                                        </a>
                                                                    </td>
                                                                </tr>
                                                                <tr v-if="listDetalles.length == 0">
                                                                    <td colspan="6" class="text-center" style="font-size: 14px;">NO HAY RESGITROS</td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                    </div>
                            ...
                            <div class="modal-content" v-if="methods == 'delete'">
                                ...
                                <div class="modal-body" style="padding: 15px 15px;">
                                    <p class="text-center">
                                        Realmente desea eliminar el Soporte Técnico <strong>"N° @{{zeroFill(id, 4)}}"</strong>
                                    </p>
                                </div>
                            ...
                            <div class="modal-content" v-if="methods == 'facturar'">
                                <div class="modal-header" style="padding: 10px 15px">
                                    <h5 class="mb-0">FACTURAR <span style="color: #929292; font-size: 17px; font-weight: 400;">(SOPORTE TÉCNICO)</span></h5>
                                    <button type="button" title="Cerrar" data-dismiss="modal" aria-label="Close" v-on:click="closeModal(methods)" class="btn btn-danger btn-xs float-right" style="padding: 0px 7px;">X</button>
                                </div>
                                <div class="modal-body" style="padding: 15px 15px;">
                                    <div class="form-row" v-if="state != 'alert-success'">
                                        <div class="form-group col-12">
                                            <label for="codigo" style="font-size: 11px;" class="mb-0">Código de Soporte</label>
                                            <input type="text" id="codigo" v-model="factura.codigo" class="form-control form-control-sm" readonly>
                                        </div>
                                        <div class="col-12 mb-3" style="border-bottom: 1px solid #7a7a7a;">
                                            <div>
                                                <strong>DATOS DE FACTURACIÓN </strong>
                                                <i class="fas fa-minus float-right" v-on:click="factura.datos = !factura.datos" v-if="factura.datos"></i>
                                                <i class="fas fa-plus float-right" v-on:click="factura.datos = !factura.datos" v-else></i>
                                            </div>
                                        </div>

                                        <template v-if="factura.datos">
                                            <div style="margin-bottom: 10px;" class="form-group col-6">
                                                <label style="font-size: 11px;" class="m-b-0" for="tipo_documento">Tipo documento</label>
                                                <select  id="tipo_documento" v-model="factura.tipo_documento" class="form-control form-control-sm" :readonly="loading">
                                                    <option value="6">RUC - Registro Único de Contribuyentes</option>
                                                    <option value="1">DNI - Documento Nacional de Identidad</option>
                                                </select>
                                            </div>
                                            <div style="margin-bottom: 10px;" class="form-group col-6">
                                                <label style="font-size: 11px;" class="m-b-0" for="numero_documento">N° Documento</label>
                                                <input type="text" id="numero_documento" v-model="factura.numero_documento" class="form-control form-control-sm" onkeypress="if (event.keyCode < 48 || event.keyCode > 57) { event.returnValue = false}" :readonly="loading">
                                            </div>
                                            <div style="margin-bottom: 10px;" class="form-group col-12">
                                                <label style="font-size: 11px;" class="m-b-0" for="denominacion">Razón Social</label>
                                                <input type="text" id="denominacion" v-model="factura.denominacion" class="form-control form-control-sm" :readonly="loading">
                                            </div>
                                            <div style="margin-bottom: 10px;" class="form-group col-12">
                                                <label style="font-size: 11px;" class="m-b-0" for="direccion">Dirección</label>
                                                <input type="text" id="direccion" v-model="factura.direccion" class="form-control form-control-sm" :readonly="loading">
                                            </div>

                                            <div style="margin-bottom: 10px;" class="form-group col-4">
                                                <label style="font-size: 11px;" class="m-b-0" for="distrito">Distrito</label>
                                                <input type="text" id="distrito" v-model="factura.distrito" class="form-control form-control-sm" :readonly="loading" v-on:click="factura.mostrar_ubigeo = !factura.mostrar_ubigeo" v-on:keyup="Ubigeo">
                                                <div v-if="factura.mostrar_ubigeo" class="mi-ubigeo">
                                                    <table class="table table-sm">
                                                        ...
                                                        <tbody>
                                                            <tr v-for="ubigeo in listaDistritos" style="cursor: pointer;" v-on:click="selUbigeo(ubigeo)">
                                            ...
                                            <div style="margin-bottom: 10px;" class="form-group col-4">
                                                <label style="font-size: 11px;" class="m-b-0" for="provincia">Provincia</label>
                                                <input type="text" id="provincia" v-model="factura.provincia" class="form-control form-control-sm" readonly>
                                            </div>
                                            <div style="margin-bottom: 10px;" class="form-group col-4">
                                                <label style="font-size: 11px;" class="m-b-0" for="departamento">Departamento</label>
                                                <input type="text" id="departamento" v-model="factura.departamento" class="form-control form-control-sm" readonly>
                                            </div>

                                            <div style="margin-bottom: 10px;" class="form-group col-6">
                                                <label style="font-size: 11px;" class="m-b-0" for="serie">Serie</label>
                                                <select id="serie" class="form-control form-control-sm" :class="[errors.serie ? 'incorrecto' : '']" :readonly="loading" v-on:change="selSerie($event)">
                                                    <option value="">Seleccion la Serie</option>
                                                    @foreach ($series as $serie)
                                                        <option value="{{$serie->id.'/'.$serie->affected_igv}}">{{$serie->serie.' - '.$serie->descripcion .' ('.$serie->forma.')'}}</option>
                                                    @endforeach
                                                </select>
                                                <small class="form-text is-invalid" v-if="errors.serie">@{{ errors.serie[0] }}</small>
                                            </div>
                                        </template>
                                        ...
                                        <div class="col-12 mb-3 mt-2" style="border-bottom: 1px solid #7a7a7a;">
                                            <div>
                                                ...
                                                <i class="fas fa-minus float-right" v-on:click="factura.detalles = !factura.detalles" v-if="factura.detalles"></i>
                                                <i class="fas fa-plus float-right" v-on:click="factura.detalles = !factura.detalles" v-else></i>
                                            </div>
                                        </div>
                                        <template v-if="factura.detalles">
                                            <div style="margin-bottom: 10px;" class="form-group col-4">
                                                <label style="font-size: 11px;" class="m-b-0" for="monto">Monto (Soles)</label>
                                                <input type="text" id="monto" v-model="factura.monto" class="form-control form-control-sm" :readonly="loading" :clas="[errors.monto ? 'incorrecto' : '']">
                                                <small class="form-text is-invalid" v-if="errors.monto">@{{ errors.monto[0] }}</small>
                                            </div>
                                            <div style="margin-bottom: 10px;" class="form-group col-8">
                                                <label style="font-size: 11px;" class="m-b-0" for="fecha_pago">Fecha pago</label>
                                                <input type="date" id="fecha_pago" v-model="factura.fecha" class="form-control form-control-sm" :readonly="loading" :class="[errors.fecha_pago ? 'incorrecto' : '']" max="{{date('Y-m-d')}}">
                                                <small class="form-text is-invalid" v-if="errors.fecha_pago">@{{ errors.fecha_pago[0] }}</small>
                                            </div>
                                            <div style="margin-bottom: 10px;" class="form-group col-4">
                                                <label style="font-size: 11px;" class="m-b-0" for="sub_total">Sub total</label>
                                                <input type="number" id="sub_total" v-model="factura.sub_total" class="form-control form-control-sm" readonly :class="[errors.sub_total ? 'incorrecto' : '']">
                                                <small class="form-text is-invalid" v-if="errors.sub_total">@{{ errors.sub_total[0] }}</small>
                                            </div>
                                            <div style="margin-bottom: 10px;" class="form-group col-4">
                                                <label style="font-size: 11px;" class="m-b-0" for="igv">IGV</label>
                                                <input type="number" id="igv" v-model="factura.igv" class="form-control form-control-sm" readonly :class="[errors.igv ? 'incorrecto' : '']">
                                                <small class="form-text is-invalid" v-if="errors.igv">@{{ errors.igv[0] }}</small>
                                            </div>
                                            <div style="margin-bottom: 10px;" class="form-group col-4">
                                                <label style="font-size: 11px;" class="m-b-0" for="total">Total</label>
                                                <input type="number" id="total" v-model="factura.total" class="form-control form-control-sm" readonly :class="[errors.total ? 'incorrecto' : '']">
                                                <small class="form-text is-invalid" v-if="errors.total">@{{ errors.total[0] }}</small>
                                            </div>
                                        </template>
                                    </div>
                                </div>
                                <div class="modal-footer" style="padding: 10px 15px;">
                                    <button class="btn btn-danger btn-block event-btn" v-on:click="Facturar" :disabled="loading">
                                        <span class="spinner-grow spinner-grow-sm" role="status" v-if="loading"></span>
                                        <span class="load-text" v-if="loading">Facturando...</span>
                                        <span class="btn-text" v-if="!loading" style=""><i class="feather icon-times"></i> Facturar</span>
                                    </button>
                                </div>
                            </div>
                            {{-- FACTURAR --}}
                            ...
                            <div class="modal-content" v-if="methods == 'avisos'">
                                ...
                                <div class="modal-body" style="padding: 15px 15px;">
                                    <table class="table table-bordered table-sm">
                                        <tbody>
                                            <tr>
                                                <td colspan="2" class="text-center" style="background-color: #ffc48e">SERVICIOS A VENCERSE</td>
                                            </tr>
                                            <tr v-for="avencer in listAVencer">
                                                <td class="text-center">
                                                    <a href="#" v-on:click="searchBarras(avencer.codigo_barras+zeroFill(avencer.id, 4))">@{{avencer.codigo_barras+zeroFill(avencer.id, 4)}}</a>
                                                </td>
                                                <td class="text-center">@{{Fecha3(avencer.fecha_entrega)}}</td>
                                            </tr>
                                            <tr>
                                                <td colspan="2" class="text-center" style="background-color: #ff6b6b">SERVICIOS VENCIDOS</td>
                                            </tr>
                                            <tr v-for="vencidos in listVencidos">
                                                <td class="text-center">
                                                    <a href="#" v-on:click="searchBarras(vencidos.codigo_barras+zeroFill(vencidos.id, 4))">@{{vencidos.codigo_barras+zeroFill(vencidos.id, 4)}}</a>
                                                </td>
                    ...
                    <div class="mb-3 mt-3">
                        ...
                        data-toggle="modal" data-target="#formularioModal" v-on:click="formularioModal('', active, 'facturar', seleccion)">
                        ...
                        data-toggle="modal" data-target="#formularioModal" v-on:click="formularioModal('', active, 'avisos', '')">
                        ...
                        <div style="display: inline-flex; margin-top: -6px; vertical-align: top;">
                            <ul class="estados">
                                <li><a href="#" v-on:click="SearchEstado('E1')">Pendientes <span class="estado-numero">@{{estados.pendiente}}</span></a></li>
                                <li><a href="#" v-on:click="SearchEstado('E2')">Diagnóstico <span class="estado-numero">@{{estados.diagnostico}}</span></a></li>
                                <li><a href="#" v-on:click="SearchEstado('E3')">Sin Solución <span class="estado-numero">@{{estados.sinsolucion}}</span></a></li>
                                <li><a href="#" v-on:click="SearchEstado('E4')">Reparando <span class="estado-numero">@{{estados.reparando}}</span></a></li>
                                <li><a href="#" v-on:click="SearchEstado('E5')">Listo <span class="estado-numero">@{{estados.listo}}</span></a></li>
                                <li><a href="#" v-on:click="SearchEstado('E6')">Entregado <span class="estado-numero">@{{estados.entregado}}</span></a></li>
                            </ul>
                        </div>
                        ...
                        <div class="float-right">
                            ...
                            <div class="input-group input-group-sm">
                                <select v-model="search" id="search" class="form-control" v-if="search_por == 'estado'">
                                ...
                                <input type="text" id="search" v-model="search" class="form-control" v-on:keyup.enter="Buscar" v-else>
                                <div class="input-group-append">
