...
@section('content')
    ...
    <div class="row" style="top: 40px; position: inherit;" id="form-roles">
                ...
                <div class="card-body">
                        ...
                        <div class="modal-dialog" :class="modal_size" role="document">
                            ...
                            <div class="modal-content" v-if="methods == 'create'">
                                <div class="modal-header" style="padding: 10px 15px">
                                    <h5 class="mb-0">NUEVO <span style="color: #929292; font-size: 17px; font-weight: 400;">(ROL)</span></h5>
                                ...
                                <div class="modal-body" style="padding: 15px 15px;">
                                    ...
                                    <div class="mi-tabla">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6" style="margin: 0 auto;">
                                                <div class="style-checkbox">
                                                    <div class="form-group form-check m-b-0">
                                                        <input type="checkbox" class="form-check-input check-xl m-t-0" id="check_all" v-on:click="checkAll">
                                                        <label class="form-check-label" for="check_all" v-on:click="checkAll">&nbsp;Seleccionar Todos</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6" v-for="(permiso, index) in listaPermisos">
                                                <div class="style-checkbox">
                                                    <div class="form-group form-check m-b-0">
                                                        <input type="checkbox" class="form-check-input check-xl mi-check m-t-0" :value="permiso.id" :id="'permission_check'+index" v-on:click="checkOne($event, index)">
                                                        <label class="form-check-label" :for="'permission_check'+index" v-on:click="checkOne($event, index)">&nbsp;@{{permiso.name}}</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <ul class="parsley-errors-list filled" v-if="errors.permisos"><li class="parsley-required">@{{ errors.permisos[0] }}</li></ul>
                                    </div>
                                </div>
                            ...
                            <div class="modal-content" v-if="methods == 'edit'">
                                <div class="modal-header" style="padding: 10px 15px">
                                    <h5 class="mb-0">EDITAR <span style="color: #929292; font-size: 17px; font-weight: 400;">(ROL)</span></h5>
                                    <button type="button" title="Cerrar" data-dismiss="modal" aria-label="Close" v-on:click="closeModal(methods)" class="btn btn-danger btn-xs float-right" style="padding: 0px 7px;">X</button>
                                </div>
                                <div class="modal-body" style="padding: 15px 15px;">
                                    <div class="form-group col-sm-12">
                                    ...
                                    <div class="mi-tabla">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6" v-for="(permiso, index) in listaPermisos">
                                                <div class="style-checkbox">
                                                    <div class="form-group form-check m-b-0">
                                                        <input type="checkbox" class="form-check-input check-xl mi-check m-t-0" :value="permiso.id" :id="'permission_check'+index" v-on:click="checkOne($event, index)" :checked="accesoCheck(permiso.id)">
                                                        <label class="form-check-label" :for="'permission_check'+index" v-on:click="checkOne($event, index)">&nbsp;@{{permiso.name}}</label>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="modal-content" v-if="methods == 'delete'">
                                <div class="modal-header" style="padding: 10px 15px">
                                    <h5 class="mb-0">ELIMINAR <span style="color: #929292; font-size: 17px; font-weight: 400;">(ROL)</span></h5>
                                    <button type="button" title="Cerrar" data-dismiss="modal" aria-label="Close" v-on:click="closeModal(methods)" class="btn btn-danger btn-xs float-right" style="padding: 0px 7px;">X</button>
                                </div>
                                <div class="modal-body" style="padding: 15px 15px;">
                                    <p class="text-center">
                                        Realmente desea eliminar el Rol <strong>"@{{nombre}}"</strong>
                                    </p>
                                </div>
                                <div class="modal-footer" style="padding: 10px 15px;">
                    ...
                    <div class="row">
                        <div class="mb-3 mt-3 col-md-9">
                            ...
                            data-bs-toggle="modal" data-bs-target="#formularioModal" v-on:click="formularioModal('modal-sm', active, 'delete', seleccion.name)">
                        ...
                        <div class="mb-3 mt-3 col-md-3">
                            <div class="p-b-10">
                                <input type="text" class="form-control" id="seacrh" v-model="search" placeholder="Nombre del rol" v-on:keyup.enter="Buscar">
                            </div>
                        ...
                        <table class="table table-sm">
                            <thead>
                                <tr>
                                    ...
                                    <th class="cell-2">Nombre del Rol</th>
                            ...
                            <tbody>
                                ...
                                <template v-if="listTable">
                                    <template v-if="listaRequest.length != 0">
                                        <tr v-for="(rol, index) in listaRequest" :class="{ activado : active == rol.id }" v-on:click="Fila(rol.id, rol)" style="cursor: pointer;">
                                            <td class="text-center">@{{(index + pagination.index + 1)}}</td>
                                            <td>@{{rol.name}}</td>
                                            <td class="text-center">@{{rol.guard_name}}</td>
                                            <td class="text-center">@{{Fecha2(rol.updated_at)}}</td>
...
@section('js')
    <script src="{{asset('js/views/administrador/roles.js')}}"></script>
@endsection
