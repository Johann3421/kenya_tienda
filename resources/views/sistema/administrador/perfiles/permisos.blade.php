                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="mb-3 mt-3 col-md-9">
                            ...
                            data-bs-toggle="modal" data-bs-target="#formularioModal" v-on:click="formularioModal('modal-sm', null, 'create', null)">
                            ...
                            data-bs-toggle="modal" data-bs-target="#formularioModal" v-on:click="formularioModal('modal-sm', active, 'edit', seleccion)">
