                ...
                <div class="card-body">
                        ...
                        <div class="modal-dialog" :class="modal_size" role="document">
                            ...
                            <div class="modal-content" v-if="methods == 'create'">
                                <div class="modal-header" style="padding: 10px 15px">
                                    <h5 class="mb-0">NUEVA <span style="color: #929292; font-size: 17px; font-weight: 400;">(CONFIGURACIÓN)</span></h5>
                                ...
                                <div class="modal-body" style="padding: 15px 15px;">
                                    <div class="form-group col-sm-12">
                                        ...
                                        <input type="text" id="nombre" v-model="nombre" class="form-control" :class="[errors.nombre ? 'is-invalid' : '']" :readonly="loading">
                                    ...
                                    <div class="form-group col-sm-12">
                                        ...
                                        <input type="file" id="file" class="form-control" :class="[errors.file ? 'is-invalid' : '']" :readonly="loading" v-on:change="File">
                                    </div>
                                </div>
                            ...
                            <div class="modal-content" v-if="methods == 'edit'">
                                <div class="modal-header" style="padding: 10px 15px">
                                    <h5 class="mb-0">EDITAR <span style="color: #929292; font-size: 17px; font-weight: 400;">(CONFIGURACIÓN)</span></h5>
                                    <button type="button" title="Cerrar" data-dismiss="modal" aria-label="Close" v-on:click="closeModal(methods)" class="btn btn-danger btn-xs float-right" style="padding: 0px 7px;">X</button>
                                </div>
                                <div class="modal-body" style="padding: 15px 15px;">
                                    <div class="form-group col-sm-12">
                                        <label for="nombre">Nombre</label>
                                        <input type="text" id="nombre" v-model="nombre" class="form-control" :class="[errors.nombre ? 'is-invalid' : '']" readonly>
                                        <small class="form-text error-color" v-if="errors.nombre">@{{ errors.nombre[0] }} </small>
                                    </div>
                                    <div class="form-group col-sm-12">
                                        <label for="descripcion">Descripcion</label>
                                    ...
                                    <div class="form-group col-sm-12" v-if="archivo_anterior">
                                        ...
                                        <div class="input-group">
                                            <input type="text" :value="archivo_anterior" class="form-control" readonly>
                                            <div class="input-group-append">
                                                <button class="btn btn-danger" title="Eliminar Archivo" v-on:click="deleteFile"><i class="fa fa-trash"></i></button>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="modal-content" v-if="methods == 'delete'">
                                <div class="modal-header" style="padding: 10px 15px">
                                    <h5 class="mb-0">ELIMINAR <span style="color: #929292; font-size: 17px; font-weight: 400;">(CONFIGURACIÓN)</span></h5>
                                    <button type="button" title="Cerrar" data-dismiss="modal" aria-label="Close" v-on:click="closeModal(methods)" class="btn btn-danger btn-xs float-right" style="padding: 0px 7px;">X</button>
                                </div>
                                <div class="modal-body" style="padding: 15px 15px;">
                                    <p class="text-center">
                            ...
                            <div class="modal-content" v-if="methods == 'image'">
                                <div class="modal-header" style="padding: 10px 15px">
                                    <h5 class="mb-0">ARCHIVO <span style="color: #929292; font-size: 17px; font-weight: 400;">(CONFIGURACIÓN)</span></h5>
                                    <button type="button" title="Cerrar" data-dismiss="modal" aria-label="Close" v-on:click="closeModal(methods)" class="btn btn-danger btn-xs float-right" style="padding: 0px 7px;">X</button>
                                </div>
                                <div class="modal-body" style="padding: 15px 15px;">
                    ...
                    <div class="row">
                        <div class="mb-3 mt-3 col-md-9">
                            ...
                            data-toggle="modal" data-target="#formularioModal" v-on:click="formularioModal('modal-sm', active, 'delete', seleccion.nombre)">
                        ...
                        <div class="mb-3 mt-3 col-md-3">
                            <div class="p-b-10">
                                <input type="text" class="form-control" id="seacrh" v-model="search" v-on:keyup.enter="Buscar">
                            </div>
                            ...
                            <tbody>
                                ...
                                <template v-if="listTable">
                                    <template v-if="listaRequest.length != 0">
                                        <tr v-for="(config, index) in listaRequest" :class="{ activado : active == config.id }" v-on:click="Fila(config.id, config)" style="cursor: pointer;">
                                            <td class="text-center">@{{(index + pagination.index + 1)}}</td>
                                            <td>@{{config.nombre}}</td>
                                            <td>@{{config.descripcion}}</td>
                                            <td class="text-center">
                                                <a href="#" v-if="config.archivo" data-toggle="modal" data-target="#formularioModal" v-on:click="formularioModal('', config.id, 'image', config)"><i class="fa fa-image"></i> @{{config.archivo}}</a>
                                            </td>
                                            <td class="text-center">
                                                <i class="fas fa-check-circle font-green" style="font-size: 15px;" v-if="config.activo == 'SI'"></i>
