    ...
    methods: {
        ...
        Buscar(page) {
            ...
            axios.post(urlBuscar, {
                ...
                this.listaRequest = response.data.modelos.data; //Datos
                this.to_pagination = response.data.modelos.to; //numero de items
        ...
        BuscarCategorias() {
            this.active = 0;
            this.mostrar = true;
            urlBuscar = '../modelos/buscarCategorias'
            axios.post(urlBuscar, {
                search: this.search_categoria,
            }).then(response => {
                // console.log(response)
        ...
        Fila_modelo(id_modelo, modelo) {
            if (this.active == id_modelo) {
                this.active = 0;
                this.seleccion = null;
            } else {
                this.active = id_modelo;
                this.seleccion = modelo;
            }
            console.log({id_modelo, modelo})
        },
        Fila_categoria(id_categoria, categoria, metodo) {
            if (this.active == id_categoria) {
                ...
                this.modelo.categoria_id = id_categoria;
                this.search_categoria = categoria.nombre;

                this.mostrar = false;
            }

            if(metodo === 'edit') {
                this.modelo.categoria_id_actualizar = id_categoria;
            }
            console.log({
                seleccion: this.seleccion,
                categoria_id: this.modelo.categoria_id,
                search_categoria: this.search_categoria,
                metodo,
                categoria_id_actualizar: this.categoria_id_actualizar
            })
        },
        formularioModal(size, id, metodo, seleccion) {
            ...
            switch (metodo) {
                ...
                case 'duplicate':
                    ...
                    this.producto_id_actualizar =  seleccion.categoria_id,
                    this.modelo.categoria_id              =  seleccion.categoria_id,
                ...
                case 'delete':
                    this.modelo.descripcion = seleccion;
                    break;
            }
        },
        Store() {
            ...
            console.log({
                ...
                modelo_imagen: this.modelo.imagen
            })
        ...
        Update() {
            ...
            console.log(this.id,
                 this.modelo.categoria_id_actualizar,
