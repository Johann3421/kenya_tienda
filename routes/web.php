...
Route::get('/', function () {
    ...
    $novedades = App\Producto::orderBy('created_at', 'DESC')->where('pagina_web', 'SI')->where('precio_anterior', null)->paginate(4);
...
// ----------------------- PRODUCTOS --------------------------------
Route::group(['middleware' => 'auth', 'middleware' => ['can:productos']], function () {
    Route::get('/producto', 'ProductoController@inicio')->name('productos');
    ...
    Route::post('/producto/web', 'ProductoController@web');
    Route::post('/producto/delete', 'ProductoController@delete');
    Route::post('/producto/duplicar', 'ProductoController@duplicar');

    // Route::post('/guardar', 'ProductoController@guardar');
    // Route::get('/todos', 'ProductoController@todos');
    // Route::get('/ver', 'ProductoController@ver');
    // Route::get('/mdl-editar-producto', 'ProductoController@mdlEditarProducto');
    // Route::post('/modificar', 'ProductoController@modificar');
    // Route::get('/mdl-eliminar-producto', 'ProductoController@mdlEliminarProducto');
    // Route::post('/eliminar', 'ProductoController@eliminar');
});
Route::get('producto/{id}/detalle', 'ProductoController@detalle')->name('producto_detalle');
